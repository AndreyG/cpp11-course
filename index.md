...
2. Использование в синхронном коде (lazy, generator, recursive_generator, ...).
3. Использование в асинхронном коде (await).
4. Обзор текущей С++ экосистемы для использования корутин.
5. Разбор типичных ловушек и ошибок.

## Модули (2 пары)
1. Мотивация, общий обзор.
2. Языковые изменения.
3. Влияние на инфраструктуру (билд-системы и другой тулинг).
4. Transition path от текущих кодовых баз к использованию модулей.
